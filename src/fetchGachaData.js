...
const fetchGachaData = async (pool, type) => {
    ...
    //https://gitee.com/yoimiya-kokomi/Yunzai-Bot/blob/main/plugins/genshin/defSet/pool/${pool}.yaml
    const res = await get(` https://genshin-gacha-banners-keypj.vercel.app/${pool}.yaml`,{
